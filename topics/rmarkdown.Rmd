...
You've written your R Markdown file. But how do you want to present it? Maybe you don't like the appearance of the web page. R Markdown has a number of [in-built themes](http://rmarkdown.rstudio.com/html_document_format.html#appearance_and_style) you could try out to quickly change the look of a web page.
...
Something has come up and you need to deliver your material in a different form. We've been creating web pages from our R Markdown file so far but now you need a PDF instead.
...
* [R Notebooks](http://rmarkdown.rstudio.com/r_notebooks.html) - sort of a special execution mode for R Markdown documents. They are pretty similiar to regular R Markdown documents now but can be shared very easily. They generate a self-contained HTML file which contains a rendered copy of the notebook which can be displayed on a website as well as a copy of the notebook .Rmd itself - handy for sharing and reproducing analyses. 
