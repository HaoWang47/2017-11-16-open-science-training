...
( This section is inspired by how Software Carpentry structures their course git repositories. However by using the `rmarkdown` package we can keep things simpler. )
