---
title: "Automation with a Makefile"
---

This section is aiming for a happy medium of flexibility. The approach is inspired by how Software Carpentry structures their course git repositories. However by using the `rmarkdown` package we can keep things simpler. `rmarkdown` also has a [`render_site`](http://rmarkdown.rstudio.com/rmarkdown_websites.html) function which can build a whole website at once, which might be sufficient to your needs.
