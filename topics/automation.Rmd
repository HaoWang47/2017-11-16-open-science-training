...
If someone wants to adapt our tutorial, they can easily do so. Having made the changes they want, the HTML files can be re-built with a single command. Be sure to give your notes an appropriate licence, such as a [Creative Commons](https://creativecommons.org/) license, so that people know they can do this without having to ask your permission.
