...
<small>
(See also: Roxygen, pydoc as examples of a different type of literate programming. Neither of these fully match Donald Knuth's initial vision.)
</small>
...
* `knitr` package to run code, knit text, code, and output into a markdown document.
* `Rmarkdown` package automates using `knitr` and `pandoc`.
